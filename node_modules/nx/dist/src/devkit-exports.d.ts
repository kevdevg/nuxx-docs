 ...
 * @category Workspace
 */
export type { ExpandedPluginConfiguration, ImplicitDependencyEntry, ImplicitJsonSubsetDependency, NxAffectedConfig, NxJsonConfiguration, PluginConfiguration, TargetDefaults, } from './config/nx-json';
/**
 * @category Logger
 */
